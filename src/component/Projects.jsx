...
//         <div className="project-section flex flex-col gap-20 items-center justify-center skill-section">
//           <h1
      ...
      <div className="flex justify-around items-center py-14 lg:px-30 xl:px-56 md:px-20 sm:px-20 md:flex-wrap lg:flex-nowrap xl:flex-nowrap hero-section">
        <div className="project-section flex flex-col gap-20 items-center justify-center">
          ...
          <div className="flex justify-center w-full items-center projects-container">
            <button onClick={handlePrev} className={`p-2 bg-transparent ${changeMode ? "" : "border-gray-500 border-solid"}`}>
              <HiArrowNarrowLeft className={`${changeMode ? "text-white" : "text-gray-500"}`} />
            </button>
            <div className="flex overflow-hidden w-full transition-transform duration-500 ease-in-out project-sec">
              {ProjectsList.slice(currentIndex, currentIndex + 1).map((project, index) => (
                <div
                  key={index}
                ...
                >
                  <div>
                    <img src={project.photo} width={400} alt={project.name} />
                  </div>
            ...
            <button onClick={handleNext} className={`p-2 bg-transparent ${changeMode ? "" : "border-gray-500 border-solid"}`}>
              <HiArrowNarrowRight className={`${changeMode ? "text-white" : "text-gray-500"}`} />
            </button>
          </div>
        </div>
      </div>
