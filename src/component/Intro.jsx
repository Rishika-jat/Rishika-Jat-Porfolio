    ...
    <>
      <div className="flex flex-col gap-4 intro-section">
        ...
        <p className=" w-2/3">
          ...
          experiences. Dive in to discover my journey, projects, and the magic I
          bring to the digital world."
        </p>
        <div className="flex gap-3">
          ...
          >
            ...
            >
              <button className="border-0 bg-transparent flex items-center justify-center">
                <FaLinkedinIn className="icon text-xl" />
              </button>
            </div>
          </a>
          <a href="https://github.com/Rishika-jat" target="_blank">
            ...
            >
              <button className="border-0 bg-transparent flex items-center justify-center">
                <FaGithub className="icon text-xl" />
              </button>
            </div>
          </a>
          <a
            href="https://app.netlify.com/teams/rishika-jat/sites"
            target="_blank"
          >
            {" "}
            <div
            ...
            >
              <button className="border-0 bg-transparent flex items-center justify-center">
                <SiNetlify className="icon text-2xl" />
              </button>
            </div>
          </a>
        </div>
      ...
      <div className="profile-div">
        <div
          className={`rounded-full h-28 w-28 relative top-20 circle-1 ${
            changeMode ? " circle-fill" : "light-circle-fill"
          }`}
        ></div>
        <div
          className={` border-purple-200 h-80 w-80  flex items-center justify-center rounded-full relative first-circle-fill ${
            changeMode ? "image-container" : "light-image-container"
          }`}
        >
          <img
            ...
            width={300}
            height={300}
            className="circular-border-image rounded-full My-image"
          />
        </div>
        <div
